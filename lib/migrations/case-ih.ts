...
export const caseIHMigrations: DbMigration[] = [
  ...
  caseIHFarmallMediumUtilityACurrentSpecsMigration,
  caseIHFarmallMediumUtilityALoadersMigration,
  caseIHFarmallMediumUtilityCCurrentSpecsMigration,
  caseIHFarmallMediumUtilityCL635LoaderMigration,
  caseIHFarmallMediumUtilityCL635LoaderUrlFixMigration,
  caseIHFarmallCompactCCurrentSpecsMigration,
  caseIHFarmallCompactCLoadersMigration,
  ...
  caseIHFarmallLargeUtilityMCurrentMigration,
