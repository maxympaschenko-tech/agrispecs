...
import { caseIHFarmallSmallUtilityACurrentSpecsMigration } from '@/lib/migrations/20260828_239_case_ih_small_utility_a_current_specs';
import { caseIHFarmallSmallUtilityALoadersMigration } from '@/lib/migrations/20260828_240_case_ih_small_utility_a_loaders';
import { caseIHFarmallMediumUtilityACurrentSpecsMigration } from '@/lib/migrations/20260828_241_case_ih_medium_utility_a_current_specs';
import { caseIHFarmallMediumUtilityALoadersMigration } from '@/lib/migrations/20260828_242_case_ih_medium_utility_a_loaders';
import { caseIHFarmallMediumUtilityCCurrentSpecsMigration } from '@/lib/migrations/20260828_243_case_ih_medium_utility_c_current_specs';
import { caseIHFarmallMediumUtilityCL635LoaderMigration } from '@/lib/migrations/20260828_244_case_ih_medium_utility_c_l635_loader';
import { caseIHFarmallMediumUtilityCL635LoaderUrlFixMigration } from '@/lib/migrations/20260828_245_case_ih_medium_utility_c_l635_loader';
import { caseIHFarmallCompactCCurrentSpecsMigration } from '@/lib/migrations/20260828_246_case_ih_compact_c_current_specs';
import { caseIHFarmallCompactCLoadersMigration } from '@/lib/migrations/20260828_247_case_ih_compact_c_loaders';
import { caseIHFarmall25SCCurrentMigration } from '@/lib/migrations/20260828_248_case_ih_farmall_25sc_current';
import { caseIHFarmallCompactACurrentSpecsMigration } from '@/lib/migrations/20260828_249_case_ih_compact_a_current_specs';
import { caseIHFarmallCompactAL340ALoaderMigration } from '@/lib/migrations/20260828_250_case_ih_compact_a_l340a_loader';
import { caseIHFarmallSmallUtilityCCurrentSpecsMigration } from '@/lib/migrations/20260828_251_case_ih_small_utility_c_current_specs';
import { caseIHFarmallSmallUtilityCL565LoaderMigration } from '@/lib/migrations/20260828_252_case_ih_small_utility_c_l565_loader';
...
import { caseIHFarmallMediumUtilityACorrectionsMigration } from '@/lib/migrations/20260828_258_case_ih_medium_utility_a_corrections';
import { caseIHFarmallMediumUtilityCCorrectionsMigration } from '@/lib/migrations/20260828_259_case_ih_medium_utility_c_corrections';
import { caseIHFarmallMediumUtilityALoaderCorrectionsMigration } from '@/lib/migrations/20260828_260_case_ih_medium_utility_a_loader_corrections';
