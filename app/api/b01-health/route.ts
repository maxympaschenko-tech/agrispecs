...
export async function GET(){
  try{
    const [
      ...
      count(`SELECT COUNT(*) AS count FROM schema_migrations WHERE id='20260827_177_kubota_b01_service_filters'`),
      count(`
    ...
    return NextResponse.json({
      ok,
      expectedLatestB01Migration:'20260827_177_kubota_b01_service_filters',
      checks,
      values:{
        ...
        attachmentRows,attachmentFitments,unsupportedNarrowAttachmentFitments,serviceParts,versionedServiceFitments,hstFilterFitments,gearHstFilterFitments,b2401DirectServiceFitments,
      },
      expected:{
        ...
        attachmentRows:2,attachmentFitments:4,unsupportedNarrowAttachmentFitments:0,serviceParts:6,versionedServiceFitments:18,hstFilterFitments:2,gearHstFilterFitments:0,b2401DirectServiceFitments:6,
      },
    },{
      status:ok?200:503,
