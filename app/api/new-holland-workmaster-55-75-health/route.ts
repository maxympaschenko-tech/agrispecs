...
export async function GET() {
  try {
    const [migration, machines, grossPower, ptoPower, cylinders, transmissions, ptoSpeed] = await Promise.all([
    ...
    return NextResponse.json(
      { ok, checks, values: { migration, machines, grossPower, ptoPower, cylinders, transmissions, ptoSpeed } },
